...
> [!NOTE]
> This page reflects the corrected v2 analysis. A replacement was submitted to arXiv on August 15, 2026, and is currently under moderation review.
...
*Figure 4: Mean sycophancy scores across eight Gemini variants and seven adversarial categories (Control condition, N=2,949). Egotistical Validation dominates across the entire family; Gen 2.5 Pro shows the most severe susceptibility (M=4.15 in this category).*
